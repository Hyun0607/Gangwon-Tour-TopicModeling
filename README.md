...
- 관광지 리뷰 텍스트 **전처리 및 클렌징**: 불용어 제거, 한글 정제, 명사 추출 등 데이터 정제 파이프라인 구축
- `MeCab` 기반 **형태소 분석기 적용** 및 LDA 모델 학습용 코퍼스 구축
- `Gensim`의 `LdaModel`을 활용한 **LDA 토픽 모델링 수행**
- 각 관광지에 대해 **주제 키워드 기반 분류 및 유사 관광지 클러스터링 기초 작업**
---
