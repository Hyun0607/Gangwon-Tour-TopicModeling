...
| 👩‍💻 팀원 A (형태소 분석 및 토큰화) | MeCab 기반 형태소 분석기 적용, LDA 학습용 토큰화 데이터 구축 |
| 👨‍💻 팀원 B (LDA 모델링) | Gensim LDA 모델 학습, 파라미터 튜닝 및 최적 토픽 수 도출 |
| 👩‍💻 팀원 C (시각화 및 분석) | pyLDAvis를 활용한 토픽 시각화, 주요 키워드 해석 및 관광지 분류 |
| 👨‍💻 팀원 D (검색 기능 및 응용) | 키워드 기반 관광지 검색 기능 구현, 유사 관광지 클러스터링 기초 설계 |
